...
export const uploadImages = async (imageDataArray) => {
    try {
        ...
        throw new Error('Erro ao enviar as imagens. Por favor, tente novamente mais tarde.');
    }
};
...
export const updateImage = async (id, title, description, price) => {
    try {
        ...
        throw new Error('Erro ao atualizar a imagem. Por favor, tente novamente mais tarde.');
    }
};
...
export const deleteImage = async (id) => {
    try {
        ...
        throw new Error('Erro ao remover a imagem. Por favor, tente novamente mais tarde.');
    }
};
...
export const fetchImages = async () => {
    try {
        ...
        throw new Error('Erro ao obter as imagens. Por favor, tente novamente mais tarde.');
    }
};
...
export const fetchCategoriesData = async () => {
    try {
        ...
        throw new Error('Erro ao obter as categorias. Por favor, tente novamente mais tarde.');
    }
};