...
export const register = async (userData) => {
    try {
        ...
        throw new Error('Erro ao registrar usuário. Por favor, verifique os dados informados e tente novamente.');
    }
};
...
export const getAuthenticatedUser = async () => {
    try {
        ...
        throw new Error('Erro ao obter usuário autenticado. Por favor, faça login novamente.');
    }
};
