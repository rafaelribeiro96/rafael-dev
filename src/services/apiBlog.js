...
const MOCK_POSTS = [
  {
    _id: '1',
    title: 'Como acelerar seu site para um carregamento ultrarrápido',
    link: 'como-acelerar-seu-site',
    description:
      'A velocidade de carregamento é o fator principal para manter clientes na página. Conheça as técnicas modernas que garantem desempenho extremo.',
    image:
