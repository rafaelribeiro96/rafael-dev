      ...
      <div className="carousel">
        ...
        <div className="carousel__nav">
          <div className="social-buttons">
            ...
            <Link href="https://www.ifood.com.br/delivery/belo-horizonte-mg/confeitaria-glayde-ribeiro-doces--bolos-salgado-filho/0ccfe710-ac48-44f0-a2e6-86e298d060ad?utm_medium=share" target="_blank" rel="noreferrer" title="link ifood glayde ribeiro">
              <Image src={ifoodpng} alt="ifood botao" className="svgbtn svg__ifood" />
            </Link>
          </div>
    ...
    <div className="carousel">
      ...
      <div className="carousel__nav">
        <div className="social-buttons">
          ...
          <Link href="https://www.ifood.com.br/delivery/belo-horizonte-mg/confeitaria-glayde-ribeiro-doces--bolos-salgado-filho/0ccfe710-ac48-44f0-a2e6-86e298d060ad?utm_medium=share" target="_blank" rel="noreferrer" title="link ifood glayderibeiro">
            <Image src={ifoodpng} alt="ifood icon" className="svgbtn svg__ifood" />
          </Link>
        </div>
