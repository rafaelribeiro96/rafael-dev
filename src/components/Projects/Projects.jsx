...
import image3 from '../../assets/images/roteiroPfeito.png';
/* import image4 from '../../assets/images/portfolio-rafael.png'; */
  ...
  return (
    <div className={styles.projects}>
      ...
      <div className={styles.cards_container_projects}>
        ...
        <Card
          image={image3}
          title="Roteiro Pfeito"
          description="Desenvolvemos um site para o Roteiro Pfeito, exibindo seu conteúdo de forma dinâmica e com a identidade visual esperada para o seu público."
          link="https://roteiropfeito.vercel.app/"
        />
        {/* <Card
          image={image4}
