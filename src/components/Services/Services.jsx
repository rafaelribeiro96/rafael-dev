    ...
    <div className={styles.services}>
      ...
      <div className={styles['right-section-services']}>
        ...
        <p className={styles['p-services']}>
          ...
          Node.js e muito mais, a SoftLuna entrega soluções sob medida para
          atender às suas necessidades exclusivas. Além de tudo oferecemos um
          gestor de conteúdo, onde poderá gerenciar as imagens e os posts do seu
          site. E conta também com uma ferramenta de Inteligencia Artificial,
          que irá auxiliar na criação de conteúdo para seu site e Instagram.
        </p>
