    ...
    <footer className={styles.footer}>
      <div className={styles['footer-content']}>
        <span className={styles['copyright-content']}>
          ...
          <span className={styles['color-autor']}>rafaeldev.com </span>
        ...
        <div className={styles['social-media-footer']}>
          <Link href="https://www.instagram.com/rafaelribeirodev/" target="_blank" rel="noreferrer" className={styles['footer-link']}>
