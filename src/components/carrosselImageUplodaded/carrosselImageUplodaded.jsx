...
function Carrossel({ images, setIsEditing, setSelectedImage, handleRemoveUploaded, openModal, deleteSvg, editarPng }) {
        ...
        <div className="container-carrosseljs">
            ...
            <div className="buttons-carrosseljs">
                <button onClick={handleLeftClick}>
                    <Image src={rightIcon} alt="Scroll Left" className="img-button-carrosseljs" />
                </button>
                <button onClick={handleRightClick}>
                    <Image src={rightIcon} alt="Scroll Right" className="img-button-carrosseljs" />
                </button>
            </div>
        </div>
    );
